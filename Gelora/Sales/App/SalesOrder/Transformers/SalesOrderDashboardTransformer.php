...
class SalesOrderDashboardTransformer extends Fractal\TransformerAbstract {
    ...
    public function transform(SalesOrderModel $salesOrder) {
        ...
        $data = [
            ...
            'unit_type_name' => $salesOrder->getAttribute('delivery.unit.type_name'),
            'unit_type_code' => $salesOrder->getAttribute('delivery.unit.type_code'),
            'sales_personnel_name' => $salesOrder->getAttribute('salesPersonnel.name'),
