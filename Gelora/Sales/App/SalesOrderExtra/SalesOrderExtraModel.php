...
class SalesOrderExtraModel extends Model {
    ...
    public function salesProgram() {
        return $this->belongsTo('\Gelora\Base\App\SalesProgram\SalesProgramModel', 'sales_program_id');
    }

    public function salesExtra() {
        return $this->belongsTo('\Gelora\Base\App\SalesExtra\SalesExtraModel', 'sales_extra_id');
    }
