    ...
    .directive('salesOrderFilter', function(
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                scope.statuses = { 'validated': 'Validasi', 'delivery_generated': 'Sudah Buat Surat Jalan', 'delivery_handover_created': 'Sudah serah terima', 'financial_closed': 'Konsumen yang sudah lunas' }
