    ...
    .directive('salesOrderFilter', function(
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                scope.dateTypes = { 'created_at': 'Tanggal SPK', 'validated_at': 'Tanggal Validasi', 'delivery.generated_at': 'Tanggal Buat Surat Jalan', 'delivery.handover.created_at': 'Tanggal Serah terima kendaraan','leasingOrder.invoice_generated_at': 'Tanggal Tagih Leasing','invoice_generated_at':'Tanggal Tagih Customer' }
