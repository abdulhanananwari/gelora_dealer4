<!DOCTYPE html>
    <html>
    <head>
    <title>Surat Pernyataan Dan Kuasa #{{$viewData['leasingOrder']}}</title>
    ...
    <div class="col-sm-12">
        ...
        <table class="table layout-table" style="width :  100%; margin-bottom: 5px;">
            <tr>
                ...
                <td>
                    ...
                    <img style="height: auto; max-width: 20em !important;" class="img-responsive pull-right" src="{{ $viewData['leasingOrder']->generateBarcode() }}">
                </td>
            </tr>       
        </table>
                ...
                <td width="50%">
                    ...
                    <table id="content">
                        <tr>
                            ...
                            <td>{{$viewData['settingCreditSales']->from['NAME']}}</td>                           
                        </tr>
                        <tr>
                            <td style="padding-left:25px;">Jabatan</td>
                            <td style="padding-left:90px;padding-right:5px;">:</td>
                            <td>{{$viewData['settingCreditSales']->from['POSITION']}}</td>    
                        </tr>
                        <tr>
                            <td style="padding-left:25px;">Alamat</td>
                            <td style="padding-left:90px;padding-right:5px;">:</td>
                            <td>{{$viewData['settingCreditSales']->from['ADDRESS']}}</td>     
                        </tr>
                        <tr>
                            <td style="padding-left:25px;">Telp</td>
                            <td style="padding-left:90px;padding-right:5px;">:</td>
                            <td>{{$viewData['settingCreditSales']->from['PHONE_NUMBER']}}</td>    
                        </tr>
                    </table>
                </td>
            </tr>
                ...
                <td width="50%">
                    ...
                    <table id="content">
                        ...
                        <tr>
                            ...
                            <td style="padding-left:25px;padding-right: 5px;">:</td>
                             <td>{{$viewData['unit']->type_name}}</td>   
                        </tr>
                        <tr>
                            <td style="padding-left:25px;">Tahun Pembuatan</td>
                            <td style="padding-left:25px;padding-right: 5px;">:</td>
                            <td>{{$viewData['unit']->assembly_year}}</td>   
                        </tr>
                        <tr>
        ...
        <table width="100%">
            <tr>
                <td>
                    <?php
                        $content = $viewData['settingCreditSales']->content;
            ...
            <tr>
                <td>
                    <p style="padding-top: 10px;">Bandung {{$viewData['leasingOrder']->invoice_generated_at->toDateString() }}</p>
                    <p>Yang Menyatakan</p>
