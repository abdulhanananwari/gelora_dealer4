...
<html>
<head>
    <title>Bukti Tagihan Leasing #{{$viewData['leasingOrder']}}</title>
    ...
    <div class="col-sm-12">
        ...
        <table class="table layout-table" style="width :  100%; margin-bottom: 5px;">
            <tr>
                ...
                <td>
                    <p class="text-right">INVOICE LEASING {{$viewData['leasingOrder']->id}}</p>
                    <img style="height: auto; max-width: 20em !important;" class="img-responsive pull-right" src="{{ $viewData['leasingOrder']->retrieve()->barcode() }}">
                </td>
            </tr>       
        </table>
        ...
        <table class="table" width="100%">
            <tr>
                <td width="50%">
                    ...
                    <table>
                        <tr>
                            <td>Bandung, {{$viewData['leasingOrder']->invoice_generated_at->toDateString()}}</td>
                        </tr>
                        <tr style="height: 8em;">
