...
<html ng-app="Gelora.PolReg">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/standard/font-awesome-4.7.0/css/font-awesome.min.css">
    ...
    <script type="text/javascript" src="{{ env('APP_ENV') == 'dev' ? ('http:' . explode(':', Request::root())[1] . ':10350/') : 'https://sms.xolura.com/'}}plugins/v1.0/all.js"></script>
