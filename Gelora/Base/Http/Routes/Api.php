...
Route::group(['prefix' => 'api', 'namespace' => 'Api', 'middleware' => $middleware], function() {
    ...
    Route::group(['prefix' => 'unit'], function() {
        ...
        Route::post('maintenance/status/{id}', ['uses' => 'UnitController@maintenanceStatus', 'middleware' => 'auth.jwt_tumr:MANAGE_UNIT']);
        Route::post('maintenance/location/{id}', ['uses' => 'UnitController@maintenanceLocation', 'middleware' => 'auth.jwt_tumr:MANAGE_UNIT']);
        Route::post('action/receive/{id}', ['uses' => 'UnitController@actionReceive', 'middleware' => 'auth.jwt_tumr:MANAGE_UNIT']);
        Route::post('action/pdi/{id}', ['uses' => 'UnitController@actionPdi', 'middleware' => 'auth.jwt_tumr:MANAGE_UNIT']);
