...
namespace Solumax\PhpHelperExtended;
...
class NumberWords {
    ...
    public function __construct($number, $include_currency = false) {
        $this->NumberWords($number, $include_currency);
    }
    
    public static function toBahasa($number, $include_currency = false) {
        $class = new NumberWords($number, $include_currency);
        return $class->get();
    }
